...
os.system(f"ffmpeg -http_persistent 0 -ss 01:10:10 -re -i '{pr}' -map 0:p:5 -c:v libx264 -c:a aac -preset ultrafast -tune zerolatency -f flv rtmp://a.rtmp.youtube.com/live2/43ys-88cy-7e3t-khew-3csa")



#os.system(f"ffmpeg -http_persistent 0 -ss 01:10:10 -re -i '{pr}' -threads 4 -vcodec copy -c:a copy -preset ultrafast -tune zerolatency -f flv rtmp://a.rtmp.youtube.com/live2/u151-yfj5-6g19-c006-a0js")
