...
os.system(f"ffmpeg -http_persistent 0 -ss 10:00:00 -re -i '{pr}' -c:v libx264 -c:a aac -g 48 -preset ultrafast -tune zerolatency -f flv rtmp://a.rtmp.youtube.com/live2/vt1b-fcp2-3u15-927x-9s3j")
