...
os.system(f"ffmpeg -http_persistent 0 -ss 5:00:00 -re -i '{pr}' -c:v copy -c:a copy -preset ultrafast -tune zerolatency -f flv rtmp://a.rtmp.youtube.com/live2/43ys-88cy-7e3t-khew-3csa")
